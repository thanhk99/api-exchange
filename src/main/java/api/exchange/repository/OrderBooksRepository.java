...
public interface OrderBooksRepository extends JpaRepository<OrderBooks, Long> {
    ...
    OrderBooks findByUidAndSymbolAndPriceAndStatusAndOrderTypeAndTradeType(String uid, String symbol,
            BigDecimal price,
            OrderStatus pending, OrderType orderType, TradeType tradeType);

    // Query methods cho getUserOrders
    List<OrderBooks> findByUid(String uid, org.springframework.data.domain.Pageable pageable);

    List<OrderBooks> findByUidAndSymbol(String uid, String symbol, org.springframework.data.domain.Pageable pageable);

    List<OrderBooks> findByUidAndStatus(String uid, OrderStatus status,
            org.springframework.data.domain.Pageable pageable);

    List<OrderBooks> findByUidAndSymbolAndStatus(String uid, String symbol, OrderStatus status,
            org.springframework.data.domain.Pageable pageable);
}
