...
public class FuturesKlineController {
    ...
    public ResponseEntity<Map<String, Object>> getKlineInfo(
        ...
        try {
            ...
            Map<String, Object> errorResponse = new HashMap<>();
            errorResponse.put("success", false);
            errorResponse.put("message", "Lỗi khi lấy thông tin futures kline: " + e.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> getAllSymbolsKlineData(
        ...
        try {
            ...
            Map<String, Object> errorResponse = new HashMap<>();
            errorResponse.put("success", false);
            errorResponse.put("message", "Lỗi khi lấy dữ liệu futures kline cho tất cả symbols: " + e.getMessage());
            errorResponse.put("interval", interval);
            errorResponse.put("data", null);
